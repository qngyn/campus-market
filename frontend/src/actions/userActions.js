...
export const logout = () => (dispatch) => {
    ...
    dispatch({ type: ORDER_LOGGED_IN_USER_RESET});
...
export const updateUserDetails = (user) => async (dispatch, getState) => { // id here stands for 'profile' -- subject to change
    try {
        dispatch({
...
export const resetUpdateUserDetails = () => (dispatch) => {
    try {
...
export const getAllUsers = () => async (dispatch, getState) => { // id here stands for 'profile' -- subject to change
    try {
        dispatch({
...
export const deleteUser = (userId) => async (dispatch, getState) => { // id here stands for 'profile' -- subject to change
    try {
        dispatch({
...
export const updateUser = (user) => async (dispatch, getState) => { // id here stands for 'profile' -- subject to change
    try {
        dispatch({
